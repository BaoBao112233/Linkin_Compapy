...
SAMPLE_COMPANIES = [
    ...
    CompanyDetail(
        ...
        description="VNG is 's leading technology company.",
        followers="88,521",
    ),
    CompanyDetail(
        name="MoMo",
        linkedin_url="https://www.linkedin.com/company/momo/",
        website="https://momo.vn",
        industry="Financial Services",
        company_size="1,001-5,000 employees",
        headquarters="Ho Chi Minh City, ",
        founded="2010",
        specialties="e-wallet, fintech, payments, ",
        description="MoMo is 's largest mobile payment platform.",
        followers="62,004",
    ),
    CompanyDetail(
        name="N26",
